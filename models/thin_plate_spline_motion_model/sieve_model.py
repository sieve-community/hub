...
@sieve.Model(
    name="hd_thin-plate-spline-motion-model",
    gpu = True,
    machine_type="a100",
    python_version="3.9",
    python_packages=[
...
class HDThinplateAvatar:
    def __setup__(self):
        import mediapipe as mp
        import cv2
        from thinplate import PlateTalkingHead
        self.model = PlateTalkingHead()
        self.model.setup('/root/.cache/lip/models/vox.pth.tar', enhance=True)
...
class ThinplateAvatar:
    def __setup__(self):
        ...
        from thinplate import PlateTalkingHead
        self.model = PlateTalkingHead()
        self.model.setup('/root/.cache/lip/models/vox.pth.tar', enhance=False)
        self.mp_face_detection = mp.solutions.face_detection
        self.face_detection = self.mp_face_detection.FaceDetection(min_detection_confidence=0.5)
