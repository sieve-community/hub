...
class Model():
    ...
    def predict(self, face, audio_file, outfile, resize_factor, faces, start_frame):
        ...
        if not audio_file.endswith('.wav'):
            ...
            command = 'ffmpeg -y -i \'{}\' -strict -2 {}'.format(audio_file, '/root/.cache/models/wav2lip/temp.wav')

            subprocess.call(command, shell=True)
            audio_file = '/root/.cache/models/wav2lip/temp.wav'
        ...
        for i, (img_batch, mel_batch, frames, coords) in enumerate(tqdm(gen, 
            ...
            if i == 0:
                ...
                out = cv2.VideoWriter('/root/.cache/models/wav2lip/result.avi', 
        ...
        command = 'ffmpeg -y -i \'{}\' -i \'{}\' -strict -2 -q:v 1 {}'.format(audio_file, '/root/.cache/models/wav2lip/result.avi', outfile)
